...
new class extends Component {
    ...
    public function updateCashier()
    {
        try {
            $this->form->update();
            session()->flash('success', 'Informasi kasir berhasil diperbarui.');
            $this->dispatch('cashier-updated', message: 'Informasi kasir berhasil diperbarui.');
            $this->dispatch('update-success', message: 'Informasi kasir berhasil diperbarui.');
...
<div>
    <div x-data="{
        ...
        successMessage: '',
        init() {
            window.addEventListener('edit-cashier-modal', (e) => {
                $wire.editCashier(e.detail.cashierId);
                this.successMessage = '';
                this.errorMessage = '';
                this.show = true;
            });
        ...
        <div class="flex max-h-[90vh] w-full max-w-md flex-col overflow-hidden rounded-lg bg-white shadow-xl dark:bg-stone-900"
            ...
            <form wire:submit.prevent="updateCashier" class="flex min-h-0 flex-1 flex-col">
                ...
                <div
                    ...
                    <button type="submit" wire:loading.attr="disabled" wire:target="updateCashier"
