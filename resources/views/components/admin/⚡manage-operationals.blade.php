...
new class extends Component {
    ...
    public function updatedFilterStore() { $this->resetPage(); }
...
<div>
    <x-page-header title="Manage Operationals" leading="Manage your operationals for your Margin Analysis." />
    ...
    <div class="mx-auto mt-2 max-w-7xl space-y-2">
        ...
        <div class="rounded-xl border border-stone-200 bg-white px-3 py-3 dark:border-stone-800 dark:bg-stone-900">
            <div class="flex flex-col gap-2 sm:flex-row sm:flex-wrap justify-end">
                ...
                <a x-data x-on:click="$dispatch('add-operational-modal')"
    ...
    <div class="mt-2 overflow-hidden rounded-xl border border-stone-200 bg-white px-4 dark:border-stone-800 dark:bg-stone-900">
            ...
            <table
                ...
                <thead>
                    <tr class="border-b border-stone-200 bg-stone-50 font-semibold uppercase tracking-wider text-stone-500 dark:border-stone-800 dark:bg-stone-800/50 dark:text-stone-400">
                        ...
                        <th class="px-2.5 py-1.5">{{ __('Operational') }}</th>
                        <th class="px-2.5 py-1.5 text-right">{{ __('Cost') }}</th>
                                ...
                                <div class="flex items-center justify-end" x-data="{ open: false }">
                                    <div class="relative inline-block text-left">
                                        ...
                                        <div x-show="open" x-transition:enter="transition ease-out duration-100"
                                            ...
                                            {{-- ⭐ FIX: ring-opacity-5 → ring-black/5 (Tailwind v4) --}}
                                            ...
                                            <div class="space-y-0.5 p-1">
                                                ...
                                                {{-- Edit — ⭐ FIX: event operasional, bukan produk --}}
                                                <button x-data
        ...
        <div class="border-t border-stone-100 px-4 py-3 dark:border-stone-800">
            {{ $operationals->links('pagination::tailwind') }}
        </div>
    </div>
