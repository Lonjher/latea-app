    ...
    <div class="mx-auto mt-2 max-w-7xl space-y-2">
        ...
        <div
            ...
            <div class="overflow-x-auto rounded-xl border bg-white shadow-sm dark:border-stone-800 dark:bg-stone-900">
                <table x-data @product-updated.window="$wire.$refresh()"
                    ...
                    <tbody class="divide-y divide-stone-100 dark:divide-stone-800/60">
                        @forelse ($products as $product)
                            <tr class="group transition-colors hover:bg-stone-50 dark:hover:bg-stone-800/30">
                                ...
                                {{-- Kolom Harga --}}
                                <td class="px-2.5 py-1.5 text-right dark:text-stone-400">
                                    <div class="font-mono text-stone-700 dark:text-stone-200">
                                        {{ $product->price }}
                                    </div>
                                    <div class="font-mono text-[9px] md:text-[10px] text-green-600 dark:text-green-400">
                            ...
                            <tr>
                                <td colspan="7" class="px-2.5 py-10 text-center">
                                    <div class="flex flex-col items-center gap-1.5 text-stone-400">
                                        <p class="text-xs font-medium">{{ __('Tidak ada produk ditemukan') }}</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
        ...
        <x-modal-hapus modal_name="open-delete-modal" action_hapus="deleteProduct" title="Hapus Produk"
            description="Data produk akan dihapus permanen dari sistem." />
    </div>
</div>
